...
[
	...
	AC_ARG_WITH(mysql,
		...
		[MYSQL_lib_check="/usr/local/mysql/lib/mysql /usr/local/lib/mysql /opt/mysql/lib/mysql /usr/lib/mysql /usr/lib64/mysql /usr/local/mysql/lib /usr/local/lib /opt/mysql/lib /usr/lib /usr/lib64"
	...
	AC_ARG_WITH(mysql-lib,
		...
		[MYSQL_lib_check="$with_mysql_lib $with_mysql_lib/lib $with_mysql_lib/lib64 $with_mysql_lib/lib/mysql $with_mysql_lib/lib64/mysql"])
