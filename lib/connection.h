...
public:
	...
	int kill(unsigned long pid) { return mysql_kill(&mysql_, pid); }
	...
	/// and open tables.
	std::string stat() { return std::string(mysql_stat(&mysql_)); }
...
#		endif
	...
	my_ulonglong insert_id() { return mysql_insert_id(&mysql_); }
