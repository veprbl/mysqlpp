...
// Doxygen will not generate documentation for this section.
	...
	MYSQLPP_EXPORT const_string() :
	str_data_("")
	{
	}
	
	/// \brief Initialize string from existing C string
	MYSQLPP_EXPORT const_string(const char* str) :
	str_data_(str)
	{
	}
	
	/// \brief Assignment operator
	MYSQLPP_EXPORT const_string& operator=(const char* str)
	{
		str_data_ = str;
		return *this;
	}
	...
	/// the string
	MYSQLPP_EXPORT const_iterator begin() const
	{
		return str_data_;
	}
	...
	/// of the string.
	MYSQLPP_EXPORT const_iterator end() const
	{
		return str_data_ + size();
	}
	
	/// \brief Return number of characters in the string
	MYSQLPP_EXPORT size_type length() const
	{
		return size();
	}
	...
	/// stored.
	MYSQLPP_EXPORT size_type max_size() const
	{
		return size();
	}
	
	/// \brief Return a reference to a character within the string.
	MYSQLPP_EXPORT const_reference operator [](size_type pos) const
	{
	...
	MYSQLPP_EXPORT const_reference at(size_type pos) const
	{
		if (pos >= size())
	...
	/// null-terminated.
	MYSQLPP_EXPORT const char* c_str() const
	{
		return str_data_;
	}
	
	/// \brief Alias for c_str()
	MYSQLPP_EXPORT const char* data() const
	{
		return str_data_;
	}
	...
	MYSQLPP_EXPORT int compare(const const_string& str) const
	{
